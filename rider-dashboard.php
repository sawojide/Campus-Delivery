...
// 1. Protect the page: Must be logged in AND have the 'rider' role
requireRole('rider', 'login.php');

$rider_id = $_SESSION['user_id'];
$rider_name = $_SESSION['user_name'] ?? 'Rider';
    ...
    <div class="row">
        ...
        <div class="col-md-10 p-4 bg-light">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div><span class="text-muted">Welcome, </span><strong><?= htmlspecialchars($rider_name) ?></strong></div>
            </div>
